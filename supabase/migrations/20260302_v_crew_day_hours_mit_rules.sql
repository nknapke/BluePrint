-- Crew day-hours patch: MIT exceptions
-- Date: 2026-03-02
-- Purpose:
--   For crew in the MIT department:
--   - lunch is paid (no unpaid lunch deduction)
--   - no daily OT after 8 hours
--   - OT starts only after 40 paid hours in the Monday-Sunday week
--
-- Existing rules remain unchanged for all other departments.
